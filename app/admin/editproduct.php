...
<section id="pluscatalog">
                    <header class="level_1_business_category_header">
                        ...
                        /
                        <a href="../admin/index.php?admin=sanpham">Thêm danh mục sản phẩm</a>
                    </header>
                    <nav class="level_1_business_pluscatalog">
                        <form action="../admin/index.php?admin=editptoduct" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="upload_product_ctalogoy_lv2">
                                        ...
                                        <div class="zone_upload_img_catalogy_lv2">
                                            <label for="img" class="preview">
                                                <div class="m">
                                                   <img src="<?=$getone_product[0]['img']?>" alt="" srcset="" style="object-fit: contain;">
                                                </div>
                                            </label>
                                            <input type="file" name="img" id="img" value="Chọn hình" hidden>
